      ...
      <div className="hero__inner">
        ...
        <div className="hero__content">
          ...
          <p className="hero__trust">
            <span className="hero__trust-item">⭐ Google 4.9</span>
            {hoursText && <><span>&nbsp;·&nbsp;</span><span className="hero__trust-item">🕐 {hoursText}</span></>}
            {cityText  && <><span>&nbsp;·&nbsp;</span><span className="hero__trust-item">📍 {cityText}</span></>}
            {igUrl && (
              <><span>&nbsp;·&nbsp;</span>
